          ...
          <div className="lg:w-1/2 w-full p-6 lg:p-12">
            <div className="max-w-md mx-auto">
              ...
              <form className="space-y-4">
                ...
                <button
                  type="submit"
                  className="btn btn-primary text-white w-full font-primary hover:bg-orange-600 text-lg py-3 mt-6"
                >
                  Register
                </button>
                <div className="divider text-gray-500 text-sm">OR</div>

                <button className="btn btn-outline w-full border-gray-300 hover:bg-gray-50 text-gray-700">
